...
<div class="thisBody" style="display:none">
    ...
    <div class="container-fluid" id="main-bg">
        ...
        <div class="wrapper theAnimation">
            ...
            @if (isset($guestName))
                <p
                    style="font-family: 'Yellowtail', cursive;width: 300px;text-align: center;transform: translateX(-50%);margin-top: 50px;font-size: 1.2em;position: absolute;z-index: 6;left: 50%;bottom: 0;">
 ...
 ">
        ...
        <a class="btn btn-success extra-card" href="https://clickadmin.searchmarketingservices.co/QR/?code=https://clickinvitation.searchmarketingservices.online/guest-checked/{{ $card[0]->id_card }}/{{ $guestCode }}/{{ $lang or '' }}" target="_blank"
            style="
...
<style>
    ...
    .letter {
        ...
        @if($card[0]->customCard)
            background: url("{{ env('APP_URL') }}assets/images/cardAnimation/{{ $card[0]->cardName }}");
    
        @else
    
            background: url("http://clickadmin.searchmarketingservices.co/eventcards/{{ $card[0]->cardName }}");
